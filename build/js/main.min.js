...
var navHeader = document.querySelector('.header__navigation');
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_3__["getScroll"])();
    var breakpointChecker = function breakpointChecker() {
      if (breakpoint.matches && modalElement.classList.contains('is-active')) {
        _modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["modals"].close('feedback');
      }
    };
...
/*!******************************************!*\
  !*** ./js/modules/modals/init-modals.js ***!
  \******************************************/
/*! exports provided: modals, initModals, TIME_OUT */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var TIME_OUT = 200;
var modals;
var headerLogo = document.querySelector('.logo__icon--phone');
var headerButton = document.querySelector('.header__navigation-toggle');
  ...
  if (navElements) {
    navElements.forEach(function (link) {
      link.addEventListener('click', function (evt) {
        evt.preventDefault();
        _modals_init_modals__WEBPACK_IMPORTED_MODULE_0__["modals"].close('feedback');
        setTimeout(function () {
        ...
        }, _modals_init_modals__WEBPACK_IMPORTED_MODULE_0__["TIME_OUT"]);
      });
    });
  }
};
